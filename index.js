...
(function () {
     ...
     * 模块7  玩家角色 Trex
     * 模块8  计分系统
     * 模块9  背景元素（Cloud / NightMode）
     * 模块10 地平线与场景总管（HorizonLine / Horizon）
     * 模块11 页面启动入口（DOMContentLoaded）
     *
     * 推荐先看：模块11 -> 模块1/2 -> 模块7 -> 模块10 -> 模块5
     * ============================================================
     */
    // ===== 模块1：运行环境与主控制器入口 =====
    // 定义全局常量、环境检测，并初始化 Runner 主控制器。
    /**
     * T-Rex runner.
